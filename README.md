...
# Modified Time: 15-01-22 14:58:29
<IfModule mod_rewrite.c>
RewriteEngine On
RewriteBase /
RewriteCond %{HTTPS} =on
RewriteCond %{HTTP_HOST} ^twoaveragegamers.com
# Start WPFC Exclude
# End WPFC Exclude
# Start_WPFC_Exclude_Admin_Cookie
RewriteCond %{HTTP:Cookie} !wordpress_logged_in_[^\=]+\=admin|flashfx21|Jim_Kernicky|Yoshyaes
...
RewriteCond /home2/twoavera/public_html/wp-content/cache/all/$1/index.html -f
